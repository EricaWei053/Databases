...
class RDBDataTable(BaseDataTable):
    ...
    def find_by_primary_key(self, key_fields, field_list=None):
        ...
        result = self.find_by_template(template, field_list, limit=None, offset=None, order_by=None, commit=True)

        if result is not None:
            result = result.get_rows()[0]
    ...
    def find_by_template(self, template, field_list=None, limit=None, offset=None, order_by=None, commit=True):
        ...
        try:
            ...
            result = self._run_q(q, args=w_clause[1], fields=field_list, commit=True, fetch=True)
            ...
            print("RDBDataTable find_by_tmp, Exception = e", e)
    ...
    def delete_by_template(self, template):
        ...
        try:
            ...
            result = self._run_q(q, args=w_clause[1], fields=None, fetch=False, commit=True)
